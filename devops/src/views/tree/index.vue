...
<span v-show="timemethod=='relative'">
  相对时间选择：<el-select   v-model="timerange" placeholder="请选择" @change="use_relative" >
      <el-option
 ...
 <iframe :src=urlnginx width="100%" height="500" frameborder="0"></iframe>
  ...
  computed:{
    ...
    urlnginx(){
      if (this.absolue){
        ...
        return "http://192.168.1.125:3000/d-solo/b2LjQttnz/ce-shi-huan-jing-nginx?orgId=1&from="+ start +"&to="+ end+ "&panelId=2"
      }
      return  "http://192.168.1.125:3000/d-solo/b2LjQttnz/ce-shi-huan-jing-nginx?orgId=1"+ this.timerange + " &panelId=2"
    },
  },
  data() {
    return {
